...
@Component({
  ...
  templateUrl: './counted-order-table.component.html',
  styleUrls: ['./counted-order-table.component.scss']
})
export class CountedOrderTableComponent implements OnInit, OnChanges {
